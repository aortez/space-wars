...
for seed, seat, mode, edit in cases:
    ...
    # Both two-cut layouts now complete through measured jetpack corridors.
    # Without a jetpack, retain the bounded-unreachable expectation.
    expected = 'blocked' if edit == 'blocked' and not args.jetpacks else 'complete'
