...
cycle-oriented RP2A03 CPU, controller/bus foundation, reference captures, and
generated test tools live in `crates/engine-nes`; it is not launcher-visible
until the PPU and Falling scenario slices land. See
