...
- M18c: Add a small preset layer once the raw controls exist. Candidate presets: Original, Small Duel, Dense Asteroids, Long Game. Presets write the same settings fields rather than adding a separate scenario fork.
