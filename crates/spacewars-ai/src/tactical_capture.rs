//! Capture V9 uses bounded touchdown corrections and robust material landing surveys.
use crate::{
    BrainReset,
...
impl TacticalCapturePilot {
    pub fn new(context: BrainReset, breaks: CombatBreakSettings) -> Self {
        ...
        sortie.policy = "tactical_sortie_v9";
        Self {
            context,
            base,
            ground: None,
    ...
    pub fn reset(&mut self, context: BrainReset) {
        ...
        self.telemetry.sortie.policy = "tactical_sortie_v9";
...
mod tests {
    ...
    fn capture_composition_preserves_versions_identity_replay_clone_and_reset() {
        ...
        assert_eq!(task.telemetry().policy, "tactical_sortie_v9");
