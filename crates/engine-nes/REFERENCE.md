...
use only ROMs generated by `test_rom::NromBuilder`, `test_rom::UxromBuilder`,
and `test_rom::CnromBuilder`.
...
UxROM bank-switching instructions, 10,000 CNROM bank-switching instructions,
