...
`test_rom::UxromBuilder`, and `test_rom::CnromBuilder`.
...
checkpoints, and savestates. The allocator test also covers `run_frame` and
repeated checkpoint restoration. Reference-host Falling evidence is recorded in
